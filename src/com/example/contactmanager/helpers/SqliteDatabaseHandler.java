...
public  class SqliteDatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_CREATED_TIME="timestamp";
    private static final String KEY_UPDATED_TIME="timestamp1";
    //private static final Bitmap PHOTO= "photo";
    ...
    Contact getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] { KEY_ID,
                KEY_NAME, KEY_MOBILE_NO,KEY_HOME_NO,KEY_EMAIL_ID,KEY_CREATED_TIME,KEY_UPDATED_TIME }, KEY_ID + "=?",
